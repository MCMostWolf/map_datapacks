...
execute as @e[type=minecraft:item,tag=horror_creeper] at @s unless function condition:entity_stats/has_vehicle run function creature:hostial/horror_creeper/event/explode
