...
execute positioned ~ ~100 ~ run function tool:quick_cmd/game/spread {num:3,min:4,max:6,float:5}
...
spawn_count:1,spawn_creature_count:1,spawn_creature_id:"invisible_spider",creature_spawner_type:"nightmare"}
...
align xyz positioned ~0.5 ~0.5 ~0.5 if block ~ ~ ~ minecraft:air run function creature:creature_spawner/nightmare/_place