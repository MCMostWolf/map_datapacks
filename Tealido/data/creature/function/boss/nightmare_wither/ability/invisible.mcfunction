...
execute if score @s skill_time matches 1100 run \
function creature:boss/nightmare_wither/control/invisible/spawn_4
execute if score @s skill_time matches 1400..1650 if predicate condition:tick/50t run \
function creature:boss/nightmare_wither/control/invisible/spawn_5
#重置
execute unless score @s skill_time matches 1650.. run return fail
