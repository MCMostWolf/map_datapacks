...
execute positioned ~-2.5 ~-2 ~-2.5 as @e[dz=4,dy=3,dx=4,type=!#noplayerne,type=!minecraft:wither] \
run damage @s 10 minecraft:magic
execute if score #difficulty gamerule matches 2 positioned ~-2.25 ~-1 ~-2.25 as @a[dz=3.5,dy=1,dx=3.5,tag=condition.playing] \
run damage @s 8 minecraft:magic
execute if score #difficulty gamerule matches 3 positioned ~-2.25 ~-1 ~-2.25 as @a[dz=3.5,dy=1,dx=3.5,tag=condition.playing] \
run damage @s 12 minecraft:magic
kill @s