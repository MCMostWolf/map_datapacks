...
data modify storage minecraft:effects translation set value [6.7f,-2.5f,-6.5f]
$data modify storage minecraft:effects scale set value $(scale)
execute store result storage minecraft:effects translation.[1] float 0.01 run random value -250..250
...
$function effects:screen/shaking_text/_display_right {text:'$(text)',scale:$(scale)}