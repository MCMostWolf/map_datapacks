...
execute as @n[distance=..0.01,type=minecraft:item,tag=loading] run function creature:creature_spawner/vanilla/control/summon/load


scoreboard players remove @s skill_cnt 1
#效果

playsound minecraft:block.lava.pop block @a ~ ~ ~ 0.7 0.6
