...
#表现
execute if score @s skill_cnt2 matches 5.. run function creature:hostial/verdure_knight/event/sheild_break
...
#格挡成功/失败
execute if function creature:hostial/verdure_knight/event/block_success run return run \
effect give @s minecraft:instant_damage 1 10 true
#
particle minecraft:explosion ~ ~1.4 ~ 1.4 0 0 1 0 normal
execute if items entity @s weapon.offhand minecraft:shield run function creature:hostial/verdure_knight/event/sheild_break
