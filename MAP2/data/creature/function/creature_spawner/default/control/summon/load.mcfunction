...
execute on passengers run item replace entity @s armor.head with acacia_boat[minecraft:item_model="minecraft:air",enchantments={"creature:tick/creature_spawner/default_summon":1}]
