...
#回血
execute unless score #temperance_in_bottle gamerule matches 1 \
if predicate condition:tick/20t unless function condition:entity_stats/has_traget run function creature:boss/nightmare_wither/control/healing
#普攻控制
