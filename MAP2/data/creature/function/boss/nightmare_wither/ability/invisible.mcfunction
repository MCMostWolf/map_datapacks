...
#
execute if score @s skill_time matches 5..800 positioned ~ ~100 ~ if predicate condition:tick/50t \
...
function creature:boss/nightmare_wither/control/invisible/spawn_2
execute if score @s skill_time matches 850 run function creature:boss/nightmare_wither/control/invisible/end
#重置
execute unless score @s skill_time matches 850.. run return fail
