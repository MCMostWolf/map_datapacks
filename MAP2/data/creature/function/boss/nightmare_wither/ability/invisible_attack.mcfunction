...
#
execute if score @s[tag=phase2] skill_time matches 1 if predicate condition:chance/chance50 run scoreboard players set @s skill 5
#
...
execute if score @s skill_time matches 40..390 run particle minecraft:squid_ink ~ ~-1.5 ~ 0 1 0 0.1 8 normal
